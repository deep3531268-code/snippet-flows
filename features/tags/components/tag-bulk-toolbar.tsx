...
function TagBulkToolbar({
  ...
  return (
    <div
      role="toolbar"
      aria-label={`Bulk actions on ${count} selected tags`}
      className="flex flex-wrap items-center gap-2 rounded-xl border border-[#2563eb]/25 bg-[#2563eb]/10 px-3 py-2 sm:px-4"
    >
