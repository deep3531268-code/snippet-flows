...
function ExploreCardSkeleton({ className }: { className?: string }) {
  return (
    <div
      className={cn(
...
function ExploreFeedSkeleton() {
  return (
    <div className="flex flex-col gap-8">
      ...
      <GridSkeleton
        count={6}
        card={<ExploreCardSkeleton />}
        label="Loading public snippets"
      />
    </div>
  )
}

export { ExploreCardSkeleton, ExploreFeedSkeleton }
